        ...
        <div className={cx("wrapper")} data-aos="fade-up">
            <div className={cx("container")}>
                ...
                <section className={cx("about__content")} data-aos="fade-left">
                    ...
                    <p>
                        We are proud to introduce our community to our first NFT exchange platform -
                        DEMARKET. This is not just a project but a journey that the BlockAlpha team
                        has tirelessly worked on to develop the first MVP test version. Every stage,
                        every line of code, and every feature has been built with dedication and
                        relentless effort to bring an excellent NFT trading experience to the
                        community.
                    </p>

                    <p>
                        Be part of the supportive community, accompany us so that demarket is not
                        just a place to trade NFTs but also a destination to share knowledge and
                        Web3 experiences. Thank you for being with us and supporting us on this
                        journey.
                    </p>
