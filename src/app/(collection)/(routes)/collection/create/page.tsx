...
const CollectionCreatePage = function ({}: Props) {
    ...
    const { mintCollection } = useContext<SmartContractType>(SmartContractContext);
    ...
    const handleCreateCollection = async function () {
        ...
        try {
            if (!lucidWallet || !walletItem) return;
            ...
            console.log("ipfs://" + responseAvatar.data.IpfsHash);
            ...
            const responseCover = await axios.post("https://api.pinata.cloud/pinning/pinFileToIPFS", formDataAvatar, {
                headers: {
                    "Content-Type": `multipart/form-data; boundary=${formDataAvatar}`,
                    Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..8D5f1dlPgVKDif5CikQtU4kd7pCcqIWvXo2Mlu5mYXk`,
                },
            ...
            console.log("ipfs://" + responseCover.data.IpfsHash);

            const { txHash } = await mintCollection({
